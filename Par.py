...
class parsingastring:
    ...
    def parse(self):
        Initial_split = self.input_string.split("=",1) #splitting the string to capture the var
        self.variable = Initial_split[0] #capturing the var
        Second_split = Initial_split[1].split(",",3) #just splitting thrice to capture values
